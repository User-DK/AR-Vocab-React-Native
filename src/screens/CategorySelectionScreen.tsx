...
export default function CategorySelectionScreen({
  ...
  const handleModeSelect = (mode: 'learning' | 'practice') => {
    ...
    if (mode === 'learning') {
      ...
      navigation.navigate("SpeechAssessment", { category: selectedCategory, itemIndex: 0 });
    }
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Text style={styles.modalSubtitle}>
              {selectedCategory ? `for ${categories.find(c => c.id === selectedCategory)?.name || selectedCategory}` : ''}
            </Text>
